 ...
 * to remove unnecessary components, clean up the code and fix some bugs */

#ifndef CSC369_EXT2_FS_H
#define CSC369_EXT2_FS_H

/* The ext2 block size used in the exercises. */
...
struct ext2_super_block {
	...
	/* Reserved blocks count is not used in the exercises. */
	 ...
	 * exercises, but is included below, for completeness.
	 ******************************************************************/
...
struct ext2_group_desc
{
	...
	/* The pad and reserved fields should be 0 for the exercises. */
...
/* Other types, irrelevant for the exercises */
...
/*
 * The remainder of the data structurs are used for directory entries.
 * You won't need them for the CSC369 exercises, but there are left here
 * for interest.
 */
